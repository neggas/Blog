...
export class JoiNColumn1618407701464 implements MigrationInterface {
    name = 'JoiNColumn1618407701464'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `subscription` ADD `subscriber_id` int NULL");
        await queryRunner.query("ALTER TABLE `subscription` ADD `subscribedTo_id` int NULL");
