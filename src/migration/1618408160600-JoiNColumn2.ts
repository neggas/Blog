...
export class JoiNColumn21618408160600 implements MigrationInterface {
    name = 'JoiNColumn21618408160600'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `subscription` CHANGE `subscriberId` `subscriberId` int NOT NULL");
        await queryRunner.query("ALTER TABLE `subscription` CHANGE `subscribedToId` `subscribedToId` int NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `subscription` CHANGE `subscribedToId` `subscribedToId` int NULL");
        await queryRunner.query("ALTER TABLE `subscription` CHANGE `subscriberId` `subscriberId` int NULL");
        await queryRunner.query("ALTER TABLE `subscription` ADD CONSTRAINT `FK_3197bb7659c450d4c033a63414f` FOREIGN KEY (`subscribedToId`) REFERENCES `profile`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `subscription` ADD CONSTRAINT `FK_95a175097e883d7d1deb5780c62` FOREIGN KEY (`subscriberId`) REFERENCES `profile`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
